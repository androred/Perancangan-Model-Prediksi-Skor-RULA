...
Repo ini ditujukan untuk memenuhi lampiran tugas akhir

#RULA Score Classification using Dual-Input CNN with Advanced Oversampling
...
- **Advanced Oversampling**: IB-GAN (In-Batch Generative Adversarial Network) dan MG-VAE (Multi-Class Generative VAE)
